...
IFontDisp = Font
__all__ = [ 'IFontEventsDisp', 'OLE_YPOS_HIMETRIC',
           'LoadPictureConstants', 'OLE_YPOS_PIXELS', 'Checked',
           'Default', 'IPicture', 'Color', 'Unchecked',
           'IPictureDisp', 'OLE_XSIZE_CONTAINER', 'IFont',
           'FONTSTRIKETHROUGH', 'VgaColor', 'FONTBOLD',
           'OLE_YSIZE_HIMETRIC', 'Picture', 'OLE_XPOS_HIMETRIC',
           'FONTUNDERSCORE', 'OLE_HANDLE', 'StdFont',
           'OLE_ENABLEDEFAULTBOOL', 'OLE_YSIZE_CONTAINER', 'FONTNAME',
           'Gray', 'IFontDisp', 'OLE_XSIZE_PIXELS', 'OLE_TRISTATE',
           'OLE_XPOS_CONTAINER', 'FONTSIZE', 'FontEvents',
           'OLE_YSIZE_PIXELS', 'OLE_XPOS_PIXELS', 'FONTITALIC',
           'OLE_CANCELBOOL', 'OLE_COLOR', 'Font',
           'OLE_XSIZE_HIMETRIC', 'OLE_YPOS_CONTAINER',
           'OLE_OPTEXCLUSIVE', 'Monochrome', 'StdPicture']
